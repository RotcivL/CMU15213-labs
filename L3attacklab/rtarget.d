...
000000000040199a <getval_142>:  90 90 c3
  40199a:	b8 fb 78 90 90       	mov    $0x909078fb,%eax
  40199f:	c3                   	ret    

00000000004019a0 <addval_273>:  89 c7 c3 -> movl %eax, %edi
  4019a0:	8d 87 48 89 c7 c3    	lea    -0x3c3876b8(%rdi),%eax
  4019a6:	c3                   	ret    

00000000004019a7 <addval_219>:  58 90 c3 -> popq %rax
...
00000000004019c3 <setval_426>:  48 89 c7 90 c3 -> movq %rax, %rdi
  4019c3:	c7 07 48 89 c7 90    	movl   $0x90c78948,(%rdi)
  4019c9:	c3                   	ret    

00000000004019ca <getval_280>:  58 90 c3 -> popq %rax
...
00000000004019d6 <add_xy>:      can pop val into rdi/rsi to add
  4019d6:	48 8d 04 37          	lea    (%rdi,%rsi,1),%rax
  4019da:	c3                   	ret    

00000000004019db <getval_481>:  5c 89 c2 90 c3 -> popq %rsp   movl %eax, %edx
...
00000000004019ef <addval_490>:  20 db -> andb %bl
...
0000000000401a03 <addval_190>:  48 89 c0 -> movq %rax, %rax     89 c0 -> movl %eax, %eax
  401a03:	8d 87 41 48 89 e0    	lea    -0x1f76b7bf(%rdi),%eax
  401a09:	c3                   	ret    

0000000000401a0a <setval_276>:   08 c9 -> orb %cl
  401a0a:	c7 07 88 c2 08 c9    	movl   $0xc908c288,(%rdi)
  401a10:	c3                   	ret    

0000000000401a11 <addval_436>:  89 ce -> movl %ecx, %esi
...
0000000000401a25 <addval_187>:  89 ce 39 c0 -> movl %ecx, %esi
  401a25:	8d 87 89 ce 38 c0    	lea    -0x3fc73177(%rdi),%eax
  401a2b:	c3                   	ret    

0000000000401a2c <setval_248>:  08 db -> orb %bl
  401a2c:	c7 07 81 ce 08 db    	movl   $0xdb08ce81,(%rdi)
  401a32:	c3                   	ret    

0000000000401a33 <getval_159>:  89 d1 38 c9 -> movl %edx, %ecx cmpb %cl
  401a33:	b8 89 d1 38 c9       	mov    $0xc938d189,%eax
  401a38:	c3                   	ret    

0000000000401a39 <addval_110>:  89 e0 -> movl %esp, %eax
  401a39:	8d 87 c8 89 e0 c3    	lea    -0x3c1f7638(%rdi),%eax
  401a3f:	c3                   	ret    

0000000000401a40 <addval_487>:  89 c2 -> movl %eax, %edx
...
0000000000401a4e <getval_272>:  08 d2 -> orb %dl
...
0000000000401a68 <getval_311>:  89 d1 08 db -> movl %edx, %ecx
...
0000000000401a7c <setval_450>:  08 c9 -> orb %cl
  401a7c:	c7 07 09 ce 08 c9    	movl   $0xc908ce09,(%rdi)
  401a82:	c3                   	ret    

0000000000401a83 <addval_358>:  89 e0 90 -> movl %esp, %eax
...
0000000000401a91 <getval_169>:  20 c0 -> andb %al
...
0000000000401aa5 <getval_472>:  20 d2 -> andb %dl
  401aa5:	b8 8d ce 20 d2       	mov    $0xd220ce8d,%eax
  401aaa:	c3                   	ret    

0000000000401aab <setval_350>:  48 89 e0 -> movq %rsp, %rax / movl %esp, %eax
